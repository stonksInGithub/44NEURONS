...
def pneu_page(pneupage):
    ...
    if pneupage == "result.html":
        return "Upload the image in the previous folder"
...
def result():    
    ...
    return render_template('result.html',filename=c, disease=dis, pneu_result=out, type=typer)
